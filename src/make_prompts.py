...
def make_system_prompt14(sep):
    """simples"""
    return f"Alternate writing tokens and '{sep}'"


def make_system_prompt15(sep):
    """simples"""
    return f"Write '{sep}' after each token"


def make_system_prompt16(sep):
